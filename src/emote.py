...
def main():
    ...
    #If config.json isn't present, just quit
...
def live(argv):
    """ Subcommand for handling live video processing
    """
...
def get_expresser():
    """Sets up the expression recognition model specified in config file

    :returns: FEExpresser - model object
    """
